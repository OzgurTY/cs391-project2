  ...
  const ProfileRightbar = () => {
    return (
      <>
        ...
        <div className="rightbarUserInfoFriends">
          <div className="rightbarInfo">
            ...
            <div className="rightbarInfoItem">
              ...
              <span className="rightbarInfoValue">
                {user.relationship === 1 ? "Single" : user.relationship === 1 ? "Not Single" : "-"}
              </span>
            </div>
          </div>
          <div className="rightbarFollowings">
            ...
            {friends.map((friend) => (
              <Link style={{ textDecoration: "none" }} to={"/profile/" + friend.username} key={friend._id}>
